const CONFIG = {
  ...
  waiting_matching: { label: 'Ghép trẻ', cls: 'bg-violet-100 text-violet-800 border-violet-200' },
  ...
  'Ghép trẻ': { label: 'Ghép trẻ', cls: 'bg-violet-100 text-violet-800 border-violet-200' },
  ...
  'Đang xác minh': { label: 'Đang xác minh', cls: 'bg-sky-100 text-sky-800 border-sky-200' },
  'Từ chối sơ bộ': { label: 'Từ chối', cls: 'bg-red-100 text-red-700 border-red-200' },
  'Chờ xác minh': { label: 'Chờ xác minh', cls: 'bg-sky-100 text-sky-800 border-sky-200' },
  'Hợp lệ': { label: 'Hợp lệ', cls: 'bg-green-100 text-green-800 border-green-200' },
  'Không hợp lệ': { label: 'Không hợp lệ', cls: 'bg-red-100 text-red-700 border-red-200' },
  'Hết hạn': { label: 'Hết hạn', cls: 'bg-rose-100 text-rose-700 border-rose-200' },
  // lịch gặp mặt
